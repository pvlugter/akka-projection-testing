...
object SimulationJsonFormat extends DefaultJsonProtocol {
  ...
  implicit val rateFunctionFormat: RootJsonFormat[RateFunctionSettings] = new RootJsonFormat[RateFunctionSettings] {
    ...
    override def read(json: JsValue): RateFunctionSettings = json match {
      ...
      case jsObject: JsObject =>
        jsObject.getFields(RateFunctionType.Field) match {
          ...
          case Seq(JsString(RateFunctionType.Sinusoidal)) => jsObject.convertTo[RateFunctionSettings.SinusoidalSettings]
          case Seq(JsString(RateFunctionType.RandomWalk)) => jsObject.convertTo[RateFunctionSettings.RandomWalkSettings]
